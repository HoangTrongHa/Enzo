    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="{{route("listadmin")}}">
                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                    管理者リスト
                </a>
                <a class="dropdown-item" data-toggle="modal" data-target="#post-create" href="{{route("listadmin")}}">
                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                    アカウントを作成する
                </a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">管理者アカウントを設定する</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" action="{{ route('post-create-admin') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">操作をキャンセルします</button>
